...
<html>
    ...
    <body>
        ...
        <div id="show-versioning" class="content scaffold-show" role="main">
            ...
            <f:display bean="versioning" />
            <g:form resource="${this.versioning}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.versioning}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
